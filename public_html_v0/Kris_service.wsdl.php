    ...
    <types>
        <xs:schema elementFormDefault="qualified"
            ...
            <xs:complexType name="Order">
                <xs:sequence>
                    <xs:element name="order_id" type="xs:string" minOccurs="1" maxOccurs="1" />
                     <xs:element name="dish_name" type="xs:string" minOccurs="1" maxOccurs="1" />
                     <xs:element name="number_of_servings" type="xs:string" minOccurs="1" maxOccurs="1" />
            ...
            <xs:element name="Request">
                <xs:complexType>
                    <xs:sequence>
                        <xs:element name="messageList" type="OrderList" />
                    </xs:sequence>
                </xs:complexType>
            </xs:element>
